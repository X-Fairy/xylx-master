    ...
    <div class="customervisit">
            ...
            <div class="visit_content">
                <div class="visit_top">
                    <h3>
                        ...
                        地址: <span @click="editaddress(address)" class="editIntention" title="点击修改客户地址">{{address}}</span>
        ...
        <!-- 修改客户地址 -->
         <Modal title="修改客户地址" v-model="addressModal" :mask-closable="false" class="userModal">
            ...
            <div class="modal_footer">
                <Button @click="editAddressQuery('addressData')">确定</Button>
            </div>
        </Modal>
    </div>
</template>
    ...
    methods:{
        ...
        */ 
        ...
        editaddress(address){
            ...
            this.addressData.newAddress=address;
        },
        /**
         * 编辑意向度时选择到哪个意向度
         */
                    ...
                    if (valid) {
                        this.$resetAjax({
                            ...
                            data: {
                                // 客户id   
                                id: this.customer.custormer_id,
                                address: this.addressData.newAddress,
                            },
                            success: (res) => {
                                if(JSON.parse(res).errorcode==0){
                                    this.address=this.addressData.newAddress;
