...
<script>
    ...
    export default{
                                ...
                                h('span', {
                                    ...
                                    on: {
                                        click: () => {
                                            ...
                                            this.formValidate.entry_date=changeday(this.formValidate.entry_date)
                                        }
                                    }
                                }, '编辑'),
                                h('span', [
        ...
        methods:{
             ...
             */
            changeStore(data) {
                this.formValidate.store_name=data.label.substring(12);
            ...
            lookStore(data){
                ...
                if(this.store=='all'){
                    this.storeList.forEach(ele=>{
                        this.storeArr.push(ele.CODE);
                    })
                }else{
                    this.storeArr=[data.value];
                }
                this.getpersonnel();
            },
            // 点击新增按钮
