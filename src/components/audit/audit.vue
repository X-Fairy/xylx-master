...
export default {
 ...
 // columns: [
            ...
            //     //     // 单元格插入图片
            //     //     render:(h, params) => {
            //     //         let text = params.row.isread ? '未审批' : '已审批';
            //     //         return h('div', [
            //     //             // 设置气泡式提醒
            //     //             h('Tooltip', {
            //     //                 props: {
            //     //                     placement: params.row.isread ? 'top' : '',
            //     //                 }
            //     //             }, [
            //     //                     h('div', {
            //     //                             slot: 'content',
            ...
            //     //                         h('icon', {
            //     //                             props: {
            //     //                             type: params.row.isread ? 'close-circled' :  'checkmark-circled',
            //     //                         },
            //     //                         style: {
            //     //                             color: params.row.isread ? '#5c6b77' : '#1d8c9f',
            //     //                             fontSize: '20px',
            //     //                             cursor: 'pointer'
            //     //                         },
            //     //                         })
            ...
            //                         click: () => {
            //                             // this.isShow = true;
            //                             this.clickIndex = row._index;
            //                             $('.ivu-table-row').eq(this.clickIndex).find('td').addClass('clicktr');
