<template>
    <div class="stored">
        <div class="top">
            <div class="left">
                ...
                <div style="margin-left: 50px;">
                    ...
                    <Button @click="daochu" style="margin-right: 50px;">导出列表</Button>
                </div>
        ...
        <div class="middle">
            <p title="点击填写金额" @click='amountShow=true'  style="cursor: pointer;background: #1596ad;color: #fff;min-height: 33px;line-height: 26px;">
            ...
            getCardlist(){
                this.$resetAjax({
                    ...
                    success:(res)=>{
                        ...
                        this.yincun=res.cash_payable;
                        this.shicun=res.cash_actual;
                        this.weicun=res.weicun;
            ...
            */
            ...
            daochu() {
                if(this.dateRange.length==0){
                    ...
                    location.href = `http://oa.xmvogue.com/index.php/NewA/Audit/dccard?store=${this.store}&time[0]=${this.dateRange[0]}&time[1]=${this.dateRange[1]}`;
                }
            },
        }
    }
